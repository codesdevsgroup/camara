...
<section class="w3l-contact-breadcrum">
  <div class="breadcrum-bg">
    <div class="container py-5">
      <p><a href="index.html">Início</a> &nbsp; / &nbsp; Contato</p>
                 ...
                 <div class="row">
                     <div class="col-lg-4 col-md-6">
                         <div class="contact-address">
                             <ul>
                                 <li class="icon-color"><span class="fa fa-map-marker"></span> <span>Pça. Geraldo Anadir, 11, Centro.
                                         <br>Materlândia - MG 39755-000</span> </li>
                             </ul>
                         </div>
                     </div>
                     <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                         <div class="contact-address">
                             <ul>
                                 <li class="icon-color"><span class="fa fa-phone"></span> <span><a class="" href="tel:+55 33 3427-1170">Telefone : +55 33 3427-1170</a><br></span></li>
                             </ul>
                         </div>
                     </div>
                         ...
                         <div class="contact-address">
                             <ul>
                                 <li class="icon-color"><span class="fa fa-mail-reply"></span><span>
                                     <a href="mailto:contato@materlandia.mg.leg.br"> contato@materlandia.mg.leg.br</a><br>
                                 </span></li>
                             </ul>
                         </div>
                     </div>
