		...
		<div class="team py-5">
			<div class="container py-lg-5">
				<div class="heading text-center mx-auto">
					<h3 class="head">Notícias</h3>
					<p class="my-3 head"> Aqui estão listadas todas as notícias da Câmara Municipal de Materlândia - MG.</p>
...
$sql = "select tituloArtigo,artigo, imgArtigo01, dataPublicacao, idArtigo from tb_artigos ORDER BY idArtigo DESC LIMIT ".$inicio. ",". $limite;
